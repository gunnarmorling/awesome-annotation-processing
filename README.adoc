...
* https://github.com/avaje/avaje-http/tree/master/http-client[avaje-http-client] - JDK 11 HttpClient Wrapper that generates rest client implementations from Feign style interfaces. 
